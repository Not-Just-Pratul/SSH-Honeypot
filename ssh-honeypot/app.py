...
Launches the honeypot server, the Streamlit dashboard, or both
depending on command-line arguments. Designed for defensive
security research and educational purposes only.

Usage:
    python app.py honeypot    Start only the SSH honeypot server
    python app.py dashboard   Start only the Streamlit dashboard
    python app.py all         Start both honeypot and dashboard
    python app.py             Start both (default)
"""
